 ...
 * @param operand - source/destination operand
 * @return - 1 - if a number 3-if its label 5- if its register otherwise 0.
 */
 ...
 * @param label - a string from the line
 * @return - error The error type if the label is a reserved word of the language otherwise returns "label"
 */
/* we check if are label is not a save word */
 ...
 * @param source_operand - Source operand of the operation opcode
 * @param destination_operand - Destination operand of the operation opcode
 * @param addressing_number - Addressing method
 */
/* function that gets the operand and the addressing number and insert into the pattern */
 ...
 * @param command_word
 * @param line -Continuation of the line
 * @return A pattern that fits the line
 */
/* line is a pointer to a char that is not a space */
 ...
 * @param command_word accepts not/clr/inc/dec/jmp/bne/red/prn/jsr
 * @param line -Continuation of the line
 * @return A pattern that fits the line
 */
 ...
 * @param command_word accepts stop or rts
 * @param line -Continuation of the line
 * @return A pattern that fits the line
 */
 ...
 * @param directive_word  - accepts .data
 * @param line -Continuation of the line
 * @return A pattern that fits the line
 */
 ...
 * @param string - a string of chars
 * @return if the string is valid string
 */
 ...
 * @param directive_word - accepts .string
 * @param line -Continuation of the line
 * @return A pattern that fits the line
 */
 ...
 * @param directive_word - accepts .entry or .extern
 * @param line - Continuation of the line
 * @return A pattern that fits the line
 */
