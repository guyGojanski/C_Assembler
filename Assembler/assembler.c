...
void printPattern(struct pattern p) {
    ...
    switch(p.pattern_option) {
        case pattern_option_directive:
            printf("Pattern Type: Directive\n");
            switch(p.option_directive_or_command.directive.directive_enum) {
                case directive_extern:
                    printf("Directive Type: .extern\n");
                    printf("Label Name: %s\n", p.option_directive_or_command.directive.opperand_option.label_name);
                    break;
                ...
                case directive_string:
                    ...
                    printf("String: %s\n", p.option_directive_or_command.directive.opperand_option.string);
                    break;
                case directive_data:
                    printf("Directive Type: .data\n");
                    for(i = 0; i < p.option_directive_or_command.directive.opperand_option.data_numbers.data_count; i++) {
                        printf("Data[%d]: %d\n", i, p.option_directive_or_command.directive.opperand_option.data_numbers.data_of_numbers[i]);
                    }
                    break;
                default:
        ...
        case pattern_option_command:
            printf("Pattern Type: Command\n");
            switch(p.option_directive_or_command.command.command_enum) {
                case command_mov:
                    printf("Command Type: mov\n");
                    break;
                case command_cmp:
                    printf("Command Type: cmp\n");
                    break;
                case command_add:
                    printf("Command Type: add\n");
                    break;
                case command_sub:
                    printf("Command Type: sub\n");
                    break;
                case command_lea:
                    printf("Command Type: lea\n");
                    break;
                case command_not:
                    printf("Command Type: not\n");
                    break;
                default:
                    printf("Unknown Command Type\n");
            }
            for(i = 0; i < 2; i++) {
                switch(p.option_directive_or_command.command.addressing_method[i]) {
                    case none:
                        printf("Operand[%d] Addressing Method: None\n", i);
                        break;
                    case number:
                        printf("Operand[%d] Addressing Method: Number\n", i);
                        printf("Operand[%d] Value: %d\n", i, p.option_directive_or_command.command.opperand[i].number);
                        break;
                    case label:
                        printf("Operand[%d] Addressing Method: Label\n", i);
                        printf("Operand[%d] Label: %s\n", i, p.option_directive_or_command.command.opperand[i].label);
                        break;
                    case register_number:
                        printf("Operand[%d] Addressing Method: Register Number\n", i);
                        printf("Operand[%d] Register Number: %d\n", i, p.option_directive_or_command.command.opperand[i].register_number);
                        break;
                    default:
                        printf("Unknown Addressing Method for Operand[%d]\n", i);
                }
            }
            break;

        case pattern_option_error:
            printf("Pattern Type: Error\n");
            break;
